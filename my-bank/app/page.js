...
import { Phone, Clock, Landmark, ArrowRight, User, ShieldCheck, PiggyBank, Percent, CreditCard, CheckCircle, Star, Lock, ChevronDown, ChevronUp, Briefcase, Handshake, Gift, Menu, X, MapPin, Mail } from 'lucide-react';
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 font-sans">
      ...
      {/* --- INFO CARDS SECTION --- */}
      <div className="relative z-20 -mt-24 container mx-auto px-6 pb-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-blue-600 text-white p-8 rounded-3xl shadow-2xl flex flex-col justify-between h-48 hover:-translate-y-2 transition duration-300">
            <div><p className="text-blue-200 text-sm font-bold uppercase tracking-wider mb-1">Routing #</p><h3 className="text-3xl font-bold">251480576</h3></div>
            <div className="self-end opacity-50"><Landmark size={48} /></div>
          </div>
